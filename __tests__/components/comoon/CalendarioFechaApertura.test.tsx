...
describe('Render calendario', () => {
  beforeEach(() => {
    render(<CalendarioFechaApertura fechaInicioApertura='2022-07-01' fechaFinApertura='2022-07-16' />)
  })
  test('Fecha de apertura coloreada', () => {
    const liInicio = screen.getByText('1')
    const liFin = screen.getByText('16')
    const liOverFin = screen.getByText('17')
